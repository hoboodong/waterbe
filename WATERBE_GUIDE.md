...
### 규칙 4: 전복 1마리 ≠ 1kg (countPerKg 반드시 사용)
> 전복 pspec의 orderUnit은 1kg이지만, 레시피 unit은 "마리"다.
> **절대로 1마리 = 1kg = unitPrice로 계산하지 말 것.**
>
> 올바른 계산:
> ```
> 1마리 무게(g) = 1,000 ÷ countPerKg
>   예) 25미 → 1,000 ÷ 25 = 40g/마리
>   예) 22미 → 1,000 ÷ 22 ≈ 45.5g/마리
>
> 단가/g = unitPrice(1kg 가격) ÷ 1,000
> 1마리 원가 = 단가/g × 1마리 무게(g)
>   예) 1kg 20,000원, 25미 → 20원/g × 40g = 800원/마리
> ```

### 규칙 5: 양배추콩나물세트 원가 중복 계산 금지
